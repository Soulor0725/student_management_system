...
| 版本 | 日期 | 主要新增 |
|------|------|---------|
| v1.8.0 | 2026-05-09 | 安全测试模块 |
| v1.7.0 | 2026-05-08 | 集成测试模块 |
| v1.6.0 | 2026-05-07 | 功能测试用例文档 |
| v1.5.0 | 2026-05-06 | API接口测试模块 |
| v1.4.0 | 2026-05-05 | 混沌测试模块 |
| v1.3.0 | 2026-05-04 | 监控模块(Prometheus+Grafana) |
| v1.2.0 | 2026-05-03 | 性能测试模块 |
| v1.1.0 | 2026-05-02 | 自动化测试模块 |
